...
rem --- Enable key fields
	ctl_name$="SAM_CUSTTYPE.YEAR"
	ctl_stat$=""
	gosub disable_fields
	ctl_name$="SAM_CUSTTYPE.CUSTOMER_TYPE"
	ctl_stat$=""
	gosub disable_fields
	ctl_name$="SAM_CUSTTYPE.PRODUCT_TYPE"
	ctl_stat$=""
	gosub disable_fields
	ctl_name$="SAM_CUSTTYPE.ITEM_ID"
	ctl_stat$=""
	gosub disable_fields
...
calc_totals:
	...
	tsls=0
	For x=1 to 13
		tcst=tcst+num(callpoint!.getColumnData("SAM_CUSTTYPE.TOTAL_COST_"+str(x:"00")))
		tqty=tqty+num(callpoint!.getColumnData("SAM_CUSTTYPE.QTY_SHIPPED_"+str(x:"00")))
		tsls=tsls+num(callpoint!.getColumnData("SAM_CUSTTYPE.TOTAL_SALES_"+str(x:"00")))
	next x
...
sam_tpl$=fnget_tpl$("SAM_CUSTTYPE")
dim sam_tpl$:sam_tpl$
while 1
	readrecord(fnget_dev("SAM_CUSTTYPE"),key=rd_key$,dom=*break)sam_tpl$
	...
	For x=1 to 13
		callpoint!.setColumnData("SAM_CUSTTYPE.QTY_SHIPPED_"+str(x:"00"),FIELD(sam_tpl$,"qty_shipped_"+str(x:"00")))
		callpoint!.setColumnData("SAM_CUSTTYPE.TOTAL_COST_"+str(x:"00"),FIELD(sam_tpl$,"total_cost_"+str(x:"00")))
		callpoint!.setColumnData("SAM_CUSTTYPE.TOTAL_SALES_"+str(x:"00"),FIELD(sam_tpl$,"total_sales_"+str(x:"00")))
	next x
	gosub calc_totals
	ctl_name$="SAM_CUSTTYPE.YEAR"
	ctl_stat$="D"
