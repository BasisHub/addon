...
callpoint!.setTableColumnAttribute("GLR_TRIALBALANCE.PICK_GL_PER","MINV","01")
callpoint!.setTableColumnAttribute("GLR_TRIALBALANCE.PICK_GL_PER","MAXV",str(num(gls01a.total_pers$):"00"))
