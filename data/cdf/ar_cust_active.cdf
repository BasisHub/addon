...
[[AR_CUST_ACTIVE.AOPT-ACTI]]
rem - Inactive Flag
gosub convert_userObj_to_array
show_all_customers$=""
gosub get_groupid
rdFuncSpace!=BBjAPI().getGroupNamespace(err=*next)
show_all_customers$=rdFuncSpace!.getValue("show_all_customers"+grpid$,err=*next)
if show_all_customers$<>"Y" then
   rdFuncSpace!.setValue("show_all_customers"+grpid$,"Y")
else
   rdFuncSpace!.setValue("show_all_customers"+grpid$,"N")
endif
...
gosub enum_popup
dim filter_defs$[2,2]
filter_defs$[1,0]="ARM_CUSTMAST.FIRM_ID"
...
if show_all_customers$<>"Y" then
   ...
   window_title$=expresso_prefix$+Translate!.getTranslation("AON_AR_CUST_LOOKUP")+" - "+Translate!.getTranslation("AON_ACTIVE")+" "+Translate!.getTranslation("AON_CUSTOMERS");rem "AR Customer Lookup - Active Customers"
   menu_opt$="OPT-ACTI"
   ...
   window_title$=expresso_prefix$+Translate!.getTranslation("AON_AR_CUST_LOOKUP")+" - "+Translate!.getTranslation("AON_ALL")+" "+Translate!.getTranslation("AON_CUSTOMERS");rem "AR Customer Lookup - All Customers"
   menu_opt$="OPT-ACTI"
