...
rem --- create list for available levels
	...
	ldat_list$=pad("Customer Type",20)+"~"+"C ;"
	if pos(sas01a.customer_lev$="PI") ldat_list$=ldat_list$+pad("Product",20)+"~"+"P ;"
	if pos(sas01a.customer_lev$="I") ldat_list$=ldat_list$+pad("Item",20)+"~"+"I ;"
