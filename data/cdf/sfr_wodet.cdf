...
seq_list$=callpoint!.getTableColumnAttribute("SFR_WODET.REPORT_SEQ","LDAT")
desc_len=pos("~"=seq_list$)
code_len=pos(";"=seq_list$)
bill_no$=""
cust_no$=""

listID=num(callpoint!.getTableColumnAttribute("SFR_WODET.REPORT_SEQ","CTLI"))
...
callpoint!.setTableColumnAttribute("SFR_WODET.REPORT_SEQ","LDAT",seq_list$)
