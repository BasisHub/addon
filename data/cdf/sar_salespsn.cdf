...
rem --- create list for available levels
	...
	ldat_list$=pad("Salesperson",20)+"~"+"S;"
	if pos(sas01a.salespsn_lev$="PI") ldat_list$=ldat_list$+pad("Product",20)+"~"+"P;"
	if pos(sas01a.salespsn_lev$="I") ldat_list$=ldat_list$+pad("Item",20)+"~"+"I;"
