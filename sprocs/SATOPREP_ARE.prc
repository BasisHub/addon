...
rem              stored in SA and is used by the "Top Salesreps" Area widget
rem              
rem
...
GOTO SKIP_DEBUG
Debug$= "C:\Dev_aon\aon\_SPROC-Debug\SATOPREP_ARE_DebugPRC.txt"	
string Debug$
debugchan=unt
open(debugchan)Debug$	
write(debugchan)"Top of SATOPREP_ARE "
SKIP_DEBUG:
